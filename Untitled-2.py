...
class MainWindow(CTk):
   def __init__(self):
       ...
       self.open_img_button = CTkButton(self, text='Img', width=50, height=40, command=self.open_image)
   ...
   def adaptive_ui(self):
       ...
       self.message_entry.configure(width=self.winfo_width() - 5 - self.open_img_button.winfo_width() - self.menu_frame.winfo_width() - self.send_button.winfo_width())
